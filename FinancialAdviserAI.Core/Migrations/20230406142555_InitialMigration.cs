        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RatioType = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FinancialRatios", x => x.Id);
                    table.ForeignKey(
                        name: "FK_FinancialRatios_Stocks_StockId",
                        column: x => x.StockId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FinancialRatios_StockId",
